...
close all;
%% -------------------------- Read file ------------------------
%filename = '1_1_horizontal_0.xlsx';    
%filename = '1_1_vertical_4.xlsx';  
filename = '1_2_horizontal_0.xlsx';  
%filename = '1_2_vertical_0.xlsx'; 
%filename = '1_2_horizontal_nFz_2.xlsx';  
%filename = '1_2_vertical_nFz_3.xlsx'; 
